...
import { lambda, LAMBDA_CONFIGURATION_ENVS } from "./lambda";
...
export const collectorCatalog: CollectorDescriptor[] = [
  ...
  { id: lambda.id, provider: lambda.provider, credentialEnv: "LAMBDA_API_KEY", configurationEnvs: LAMBDA_CONFIGURATION_ENVS, documentation: "https://docs.lambda.ai/public-cloud/cloud-api/", defaultEnabled: false },
