...
6. Each component must pin the exact reviewed catalog `description`. The collector rejects description drift even when usage type remains unchanged. This detects changes; it does not prove that the original human-reviewed procurement classification or bundle composition was correct.
