...
| Provider APIs | Oracle, Azure and Verda public catalog requests currently need no key | Data owner; obtain applicable publication rights; quote other APIs and data licensing separately |
